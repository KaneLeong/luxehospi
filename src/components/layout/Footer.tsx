...
export default function Footer() {
  ...
  return (
    <footer className="bg-navy-dark py-10 md:py-16 px-0">
      <div className="max-w-container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[2fr_1fr_1fr_1fr] gap-8 md:gap-12 mb-10 md:mb-12">
          {/* Brand */}
          <div>
            <Link to="/" className="flex items-center gap-3 no-underline">
              <img
                ...
                alt="LUXEHOSPI"
                className="h-[26px] md:h-[30px] w-auto -mt-1"
                loading="lazy"
              />
              <span className="font-heading text-lg md:text-xl font-bold text-white tracking-wider">
          ...
          {/* Products */}
          <div>
            <h4 className="font-heading text-[13px] font-bold text-gold uppercase tracking-[1.5px] mb-5">
              Products
            </h4>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="text-[13px] text-white/35">
            &copy; {currentYear} LUXEHOSPI. All rights reserved.
          </div>
          <div className="flex gap-3">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-9 h-9 border border-white/20 flex items-center justify-center text-white/50 no-underline hover:border-gold hover:text-gold transition-colors"
              >
                {social.icon}
              </a>
            ))}
